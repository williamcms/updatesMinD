    ...
    $.ajax({
      ...
      if ($(`.row.newFields[data-input=${inputN}]`).length >= 1) {
        ...
        $('.row.newFields')
          ...
          .val(`${product.link}?reportEmail=produto_${inputN}`)
        $('.row.newFields')
